...
*                                                                     *
***********************************************************************
      SUBROUTINE MODEL_IC__ERYB_KCR2( P, N )
      IMPLICIT NONE
*     .. Inputs
      DOUBLE PRECISION  P(*)
*     .. Outputs
...
*                                                                     *
***********************************************************************
      SUBROUTINE MODEL_INCL__ERYB_KCR2( P )
      IMPLICIT NONE
*     .. Inputs
*     .. Outputs
      LOGICAL           P(*)
...
***********************************************************************
*                                                                     *
*     - MODEL ERYB-plus-K_CR2 -                                       *
*       Original model plus a 2nd cross-relaxation term feeding       *
*       level n_2 to account for the fast rise of the 1500nm output.  *
*                                                                     *
***********************************************************************
      SUBROUTINE MODEL__ERYB_KCR2( N, P,  dN )
      IMPLICIT NONE
*     .. Inputs
...
*#                                                                      #
*#   2.  k_CR1    Er3+: 4I_15/2 (n1)  --> 4I_13/2 (n2)                  #
*#                Er3+: 4S_3/2  (n6)  --> 4I_9/2  (n3)                  #
*#       NOTE: k_CR1 is the same as k_CR                                #
*#                                                                      #
*#   3.  k_CR2    Er3+: 4I_15/2 (n1)  --> 4I_13/2 (n2)                  #
*#                Er3+: 4I_11/2 (n3)  --> 4I_13/2 (n2)                  #
*#                                                                      #
*#   4.  k_ET1    Yb3+: 2F_5/2  (np2) --> 2F_7/2  (np1)                 #
*#                Er3+: 4I_15/2 (n1)  --> 4I_11/2 (n3)                  #
*#                                                                      #
*#   5.  k_ET2    Yb3+: 2F_5/2  (np2) --> 2F_7/2  (np1)                 #
*#                Er3+: 4I_13/2 (n2)  --> 4F_9/2  (n5)                  #
*#                                                                      #
*#   6.  k_ET3    Yb3+: 2F_5/2  (np2) --> 2F_7/2  (np1)                 #
*#                Er3+: 4I_11/2 (n3)  --> 4F_7/2  (n7) --> 4S_3/2 (n6)  #
*#                                                                      #
*#   7.  k'_ET1   Yb3+: 2F_7/2  (np1) --> 2F_5/2  (np2)                 #
*#                Er3+: 4I_11/2 (n3)  --> 4I_15/2 (n1)                  #
*#                                                                      #
*#   8.  k'_ET2   Yb3+: 2F_7/2  (np1) --> 2F_5/2  (np1)                 #
*#                Er3+: 4F_9/2  (n5)  --> 4I_13/2 (n2)                  #
*#                                                                      #
*#   9.  k_R1     Er3+: 2H_11/2 (n6)  --> 4I_15/2 (n1)   Green          #
*#                Er3+: 2H_11/2 (n6)  --> 4I_13/2 (n2)                  #
*#                Er3+: 2H_11/2 (n6)  --> 4I_11/2 (n3)                  #
*#                                                                      #
*#   10. k_R2     Er3+: 4F_9/2  (n5)  --> 4I_15/2 (n1)   Red            #
*#                Er3+: 4F_9/2  (n5)  --> 4I_13/2 (n2)                  #
*#                Er3+: 4F_9/2  (n5)  --> 4I_11/2 (n3)                  #
*#                                                                      #
*#   11. k_R3     Er3+: 4I_11/2 (n3)  --> 4I_15/2 (n1)   976nm          #
*#                Er3+: 4I_11/2 (n3)  --> 4I_13/2 (n2)                  #
*#                                                                      #
*#   12. k_n2     Er3+: 4I_13/2 (n2)  --> 4I_15/2 (n1)   1500nm (NIR)   #
*#                                                                      #
*#   13. k_NR1    Er3+: 4S_3/2  (n6)  --> 4F_9/2  (n5)                  #
*#                                                                      #
*#   14. k_NR2    Er3+: 4I_11/2 (n3)  --> 4I_13/2 (n2)                  #
*#                                                                      #
*########################################################################
     ...
     &            -               P(_k_CR1_)  * N(_n1_) * N(_n6_)
     &            -               P(_k_CR2_)  * N(_n1_) * N(_n3_)
...
*       Generate the radiative outputs for the ErYb-plus-k_CR2 model  *
*       given the current populations.                                *
*                                                                     *
***********************************************************************
c      SUBROUTINE RADOUT__ERYB_KCR2( B, K, N, R )
c      SUBROUTINE RADIATIVES__ERYB_KCR2( N, B, K, R )
      SUBROUTINE RADIATIVES__ERYB_KCR2( N, P,  R )
      IMPLICIT NONE
*     .. Inputs
